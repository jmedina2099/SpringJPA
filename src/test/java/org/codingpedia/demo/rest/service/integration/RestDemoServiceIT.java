...
public class RestDemoServiceIT {
	...
	public void testGetPodcasts() throws JsonGenerationException,
		...
		WebTarget webTarget = client
				.target("http://localhost:8888/hello/podcasts/");
	...
	@Test
	public void testGetPodcast2() throws JsonGenerationException,
			JsonMappingException, IOException {
		...
		WebTarget webTarget = client
				.target("http://localhost:8888/hello/podcasts/2");
	...
	public void testGetLegacyPodcasts() throws JsonGenerationException,
		...
		WebTarget webTarget = client
				.target("http://localhost:8888/hello/legacy/podcasts/");
	...
	@Test
	public void testGetLegacyPodcast2() throws JsonGenerationException,
			JsonMappingException, IOException {
		...
		WebTarget webTarget = client
				.target("http://localhost:8888/hello/legacy/podcasts/2");
